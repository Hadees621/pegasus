...
import SimpleLi from "./comp/SimpleLi";
import TitleLi from "./comp/TitleLi";
import LastLi from "./comp/LastLi";
import MegaMenu from "./comp/MegaMenu";
    ...
    return (
        <>
            ...
            <nav className="bg-white border-gray-200">
                ...
                <MegaMenu isMegaMenuOpen={isMegaMenuOpen} />
