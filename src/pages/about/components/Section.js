        ...
        <>
            ...
            <div className="w-full justify-center 320:px-6 768:px-12 1024:px-52 1440:px-[340px] 1535:px-[381px] 2000:px-[700px]">
                ...
                <div className="flex items-center 1024:mt-6 320:py-8 1024:py-4 2000:py-12">
                    ...
                    <div className="text-[#757C97] 320:text-lg 1024:text-[11px] 1440:text-[15px] 2000:text-[20px] font-fairplay px-2">What we believe
                    </div>
                    <div className="flex-grow border-t border-[#757C97]"></div>
                </div>
                ...
                <div className="flex flex-col 1024:flex-row">
                    ...
                    <div className="w-full 1024:w-[27%] space-y-6 1024:space-y-3 2000:space-y-6 1024:pr-10">
                        ...
                        <h1 className="text-center 1024:text-start text-[20px] 1024:text-[12px] 1440:text-[15px] 2000:text-[24px] text-[#B79248] font-fairplay">Our Authors and Readers</h1>
                        <p className="text-center 1024:text-start text-[#62676D] text-[14px] 1024:text-[10px] 1440:text-[13px] 2000:text-[20px] font-fairplay">Sustainable way of working</p>
                        <p className="text-center 1024:text-start text-[#62676D] text-[14px] 1024:text-[10px] 1440:text-[13px] 2000:text-[20px] font-fairplay">A diverse workforce</p>
                        <p className="text-center 1024:text-start text-[#62676D] text-[14px] 1024:text-[10px] 1440:text-[13px] 2000:text-[20px] font-fairplay">Rewardable and memorable
                            publishing journey
                        </p>
                    ...
                    <div class="w-full 1024:w-[73%] mt-10 1024:mt-0">
                        ...
                        <h1 className="text-center 1024:text-start text-[24px] 1024:text-[14px] 1440:text-[16px] 2000:text-[28px] text-[#B79248] font-fairplay"> Our Authors and Readers </h1>
