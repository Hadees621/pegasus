...
const ByAlpha = ({ alpha }) => {
    ...
    return (
        <>
            <div className="1024:px-52 1440:px-72 2560:px-[550px] py-40">
                <h1 className="text-[100px] text-[#B79248] font-fairplay px-5 text-start">{currentLetter}</h1>
                <div className="grid md:grid-cols-3 lg:grid-cols-5 1024:gap-x-2 1024:gap-y-2.5 2560:gap-y-6 2560:gap-x-6 1440:gap-x-5 gap-y-7 320:p-5 1024:py-0  768:gap-x-4 mb-44">
