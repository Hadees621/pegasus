...
const Section = () => {
    ...
    return (
        <>
            ...
            <div className="w-full justify-center 320:px-6 768:px-12 1024:px-52 1440:px-[290px] 1535:px-[360px] 2000:px-[660px] py-28">

                <div className="grid grid-cols-4 gap-y-6">
                    {alphabets.split("").map((letter, index) => (
                        <div key={index} className="group flex flex-col items-center justify-center h-[250px] w-[250px] border-[1.5px] border-[#151516] rounded-md hover:bg-[#EEF1F2]">
                            <h1 className="text-[110px] font-fairplay text-[#CCCDCD] group-hover:text-black">{letter}</h1>
