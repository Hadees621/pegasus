            ...
            <div className="w-full justify-center items-center 320:px-3 425:px-4 768:px-10 1024:px-[240px] 1440:px-[400px] 1535:px-[430px] 2000:px-[500px] 2560:px-[700px] py-28 1024:py-10 1440:py-24">
                <div className="flex flex-col 1024:flex-row space-y-14 1024:space-y-0 1024:-space-x-6 1440:-space-x-0 justify-center">
                    <div className="w-full 1024:w-[27%] space-y-6 1024:space-y-3 2000:space-y-7">
                        <h1
                            className={`text-center 1024:text-start text-[24px] 1024:text-[9px] 1440:text-[13px] 2000:text-[20px] ${selectedHeading === "Terms & Conditions" ? "text-[#B79248]" : "text-[#99A1A4]"
                        ...
                        <h1
                            className={`text-center 1024:text-start text-[24px] 1024:text-[9px] 1440:text-[13px] 2000:text-[20px] ${selectedHeading === "Policies & Cookies" ? "text-[#B79248]" : "text-[#99A1A4]"
                                } font-fairplay cursor-pointer`}
                        ...
                        <h1
                            className={`text-center 1024:text-start text-[24px] 1024:text-[9px] 1440:text-[13px] 2000:text-[20px] ${selectedHeading === "Shipping & Returns" ? "text-[#B79248]" : "text-[#99A1A4]"
                                } font-fairplay cursor-pointer`}
                        ...
                        <h1
                            className={`text-center 1024:text-start text-[24px] 1024:text-[9px] 1440:text-[13px] 2000:text-[20px] ${selectedHeading === "Rights & Permissions" ? "text-[#B79248]" : "text-[#99A1A4]"
                                } font-fairplay cursor-pointer`}
