        ...
        <div className="grid 768:grid-cols-3 1024:grid-cols-6 justify-center 2560:mt-6 768:mx-2">
            {fantasyReadData.map((book, index) => (
                <div key={index} className="relative m-4 p-3 1024:m-1 1024:p-1 text-center 768:m-0 1440:m-1">
                    <div className="relative bg-cover bg-center rounded-md overflow-hidden w-[240px] h-[420px] 1024:h-[180px] 1024:w-[110px] 1440:h-[210px] 2560:w-[240px] 2560:h-[380px]" style={{ backgroundImage: `url(${book.imageSrc})`, }}>
                        {/* width: '240px', height: '380px' */}
                        <div className="absolute top-0 right-0 p-2 1024:p-1 cursor-pointer bg-white rounded-full m-2 1024:m-1">
                            {/* */}
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.3em" viewBox="0 0 24 24" className='1024:w-3 1024:h-3'>
