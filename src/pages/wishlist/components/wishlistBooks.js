...
function WishlistBooks() {
    return (
        <div className="grid 768:grid-cols-3 1024:grid-cols-6 justify-center 2560:mt-6 768:mx-2 1535:gap-1">
            {fantasyReadData.map((book, index) => (
                <div key={index} className="relative m-4 p-3 1024:m-1 1024:p-1 text-center 768:m-0 1440:m-1">
                    <div className="relative bg-cover bg-center rounded-md overflow-hidden w-[240px] h-[420px] 1024:h-[180px] 1024:w-[110px] 1440:w-[150px] 1440:h-[210px] 2560:w-[270px] 2560:h-[390px]" style={{ backgroundImage: `url(${book.imageSrc})`, }}>
                        <div className="absolute top-0 right-0 p-2 1024:p-1 cursor-pointer bg-white rounded-full m-2 1024:m-1 2000:m-2 2000:p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.3em" viewBox="0 0 24 24" className='1024:w-3 1024:h-3 2000:w-7 2000:h-7'>
                    ...
                    <div className='w-full text-start my-2'>
                        <h3 className="1024:text-[9px] 1440:text-[11px] 2560:text-[19px] font-medium font-fairplay ">{book.title}</h3>
                        <p className="1024:text-[8px] 1440:text-[9px] 2560:text-[17px] text-[#B79248] font-roboto">{book.author}</p>
                        <h3 className="1024:text-[9px] 1440:text-[11px] 2560:text-[19px] font-medium font-fairplay ">£0.00</h3>
                    </div>
                    <div className='py-4 2000:py-8'>
                        <DropdownMenu />
                        <button className='w-full border border-[#CCCED1] h-[40px] my-5 1024:h-[28px] 2000:h-[54px] rounded-3xl 2000:my-10 flex items-center justify-center'>
                            ...
                            <span className="ml-3 text-[12px] 1024:ml-1 1024:text-[9px] 2000:text-[18px] font-fairplay items-center">Add to cart</span>
                        </button>
                    </div>
                </div>
            ))
