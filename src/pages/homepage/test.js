        ...
        <>
            ...
            <div className="w-full justify-center 320:px-6 768:px-12 1024:px-52 1440:px-[290px]  2xl:px-[700px]">
                ...
                <div className="flex flex-col 1024:flex-row">
                    ...
                    <div className="w-full 1024:w-[27%] space-y-6 1024:space-y-3 2560:space-y-6 1024:pr-10">

                        <h1 className="text-center 1024:text-start text-[20px] 1024:text-[12px] 1440:text-[15px] 2560:text-[24px] text-[#B79248] font-fairplay">Our Authors and Readers</h1>
                        <p className="text-center 1024:text-start text-[#62676D] text-[14px] 1024:text-[10px] 1440:text-[13px] 2560:text-[20px] font-fairplay">Sustainable way of working</p>
                        <p className="text-center 1024:text-start text-[#62676D] text-[14px] 1024:text-[10px] 1440:text-[13px] 2560:text-[20px] font-fairplay">A diverse workforce</p>
                        <p className="text-center 1024:text-start text-[#62676D] text-[14px] 1024:text-[10px] 1440:text-[13px] 2560:text-[20px] font-fairplay">Rewardable and memorable
                            publishing journey
                        </p>

                    </div>
                    <div class="w-full 1024:w-[73%] mt-10 1024:mt-0">

                        <h1 className="text-center 1024:text-start text-[24px] 1024:text-[14px] 1440:text-[16px] 2560:text-[28px] text-[#B79248] font-fairplay"> Our Authors and Readers </h1>
                        <p className="text-center 1024:text-start text-[14px] 1024:text-[8px] 1024:leading-4 1440:text-[12px] 1440:leading-6 2560:text-[18px] 2560:leading-8 1024:mt-2  mt-6 leading-6 font-roboto">
                        ...
                        {/* image */}
                        <div
                            className="relative bg-cover bg-center hidden 1024:flex 1024:h-[149px] 1440:h-[200px] 2560:h-[270px] my-10 w-full"
                        ...
                        >
                            <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 text-center text-[#F8F4EB] w-full">
                                ...
                                <p className="text-center 320:mt-6 1024:mt-0">
                                    <a href="#" className="text-[#ECEAE7] 1024:text-[8px] 1440:text-[11px] 2560:text-[18px] 2560:mt-6 font-fairplay tracking-wide inline-block pb-[2px] border-b border-[#ECEAE7]">Explore</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {/* History */}
            <div className="w-full bg-[#F8F5EF] py-32 mt-20 1024:py-16 2560:py-48">

                <div className="320:mx- 768:mx-12 1024:mx-52 1440:mx-[290px] 2xl:mx-[720px]">
                    <h1 className="flex justify-center text-black font-fairplay text-[24px] leading-7 tracking-tight 1024:text-start 320:text-[28px] 1024:text-[23px] 1440:text-[32px] 1440:leading-9 2560:text-[55px] 2560:leading-[60px]">
                    ...
                    <div className="flex flex-col 1024:flex-row mt-8 gap-8 p-3 1024:gap-2 2560:gap-6 1024:mt-2 1440:mt-7 2560:mt-20">

                        <div className="flex flex-col w-full px-10 py-20 2560:px-20 2560:py-12 group hover:bg-black hover:shadow-xl hover:shadow-[#F8E8EE] hover:text-white transition-all border border-black rounded-md items-center">
            ...
            <div className="w-full justify-center 320:px-6 768:px-12 1024:px-52 1440:px-[290px] 2xl:px-[550px]">
                ...
                <div class="relative m-4 p-4 bg-cover bg-center 320:h-[380px] 1024:h-[200px] 1440:h-[270px] 2560:h-[500px] my-20" style={{ backgroundImage: `url('assests/about/books.jpg')` }}>
                    <div class="absolute 320:bottom-1 320:left-1 bottom-8 left-8 p-4 text-white 1024:p-1 1024:bottom-2 1024:left-4 1440:p-5 1440:bottom-2 2560:p-9 gap-0">
                        <h3 class="320:text-[32px] text-[48px] font-fairplay text-white 1024:text-black 1024:text-[18px] 1440:text-[28px] 2560:text-[60px] -mb-0 leading-10">Publishing Process</h3>
                        <p class="320:text-[13px] text-base text-white 1024:text-black 1024:text-[8px] 1440:text-[10px] 2560:text-[16px]">Lorem ipsum dolor sit amet, consectetuer adipscing elit.
                            .</p>
                        <button className="bg-white text-lg text-black rounded-3xl 1440:w-[100px] 1440:h-7 1440:text-[11px] 2560:text-[15px] 2560:w-[150px] 2560:h-11 font-fairplay 1024:w-[60px] 1024:h-[18px] 1024:text-[8px] items-center flex justify-center font-extralight mt-2 1440:mt-3 2560:mt-7 320:w-[100px] 320:text-[13px]">View all</button>
                    </div>
                </div>
