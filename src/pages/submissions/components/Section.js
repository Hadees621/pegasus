    ...
    return (
        <>
            ...
            <div className="flex flex-col 1024:flex-row w-full justify-center 1024:px-40 xl:px-52 2560:px-96 py-32 gap-10 border">
                ...
                <div className="flex flex-col items-center justify-center text-center group bg-white border  w-full  ">
                    <img className="flex items-center justify-center w-full" src="assests/submissions/Asset1.png" alt="Section Image" />
                    <p className="text-center 425:text-start text-[24px] 425:text-[16px] 1024:text-[14px] 1440:text-[16px] 2000:text-[28px] text-[#B79248] font-fairplay">
                ...
                <div className="flex flex-col items-center justify-center text-center group bg-white w-full border shadow-xl p-10">
                    <img className="flex items-center justify-center w-full" src="assests/submissions/Asset1.png" alt="Section Image" />
                    <p className="text-center my-8 425:text-start text-[24px] 425:text-[16px] 1024:text-[14px] 1440:text-[16px] 2000:text-[28px] text-[#B79248] font-fairplay">
                        Completing your manuscript
                    </p>
                </div>
                <div className="flex flex-col items-center justify-center text-center group bg-white w-full border shadow-xl p-10">
                ...
                </div><div className="flex flex-col items-center justify-center text-center group bg-white w-full border shadow-xl p-10">
                    <img className="flex items-center justify-center w-full" src="assests/submissions/Asset3.png" alt="Section Image" />
                    <p className="text-center my-8 425:text-start text-[24px] 425:text-[16px] 1024:text-[14px] 1440:text-[16px] 2000:text-[28px] text-[#B79248] font-fairplay">
                        Completing your manuscript
                    </p>
                </div>
