...
const Section = () => {
    return (
        <>
            ...
            <div className="flex flex-col 2000:mx-[430px] 2000:gap-16 mx-6 mb-20 1024:flex-row 1024:gap-6 1024:mx-[230px] 1440:mx-[350px]  1535:mx-[440px] 1827:mx-[500px] 2560:mx-[530px] 1024:my-36">
                <AboutYou />
                <AboutBook />
            </div>
        </>
